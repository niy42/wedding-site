import { PaymentInitializationError, PaymentVerificationError, } from "../../domain/payment.errors.js";
...
export class PaystackProvider {
    ...
    async initializeTransaction(request) {
        try {
            ...
            throw new PaymentInitializationError("Failed to initialize Paystack transaction", error);
        }
    }
    async verifyTransaction(reference) {
        try {
            ...
            throw new PaymentVerificationError(`Failed to verify Paystack transaction ${reference}`, error);
        }
    }
