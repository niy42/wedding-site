...
export async function adminLogin(res, body) {
    if (!body || typeof body !== "object" || !verifyAdminPasscode(body.passcode)) {
        throw new HttpError(401, "Invalid admin credentials");
    }
    setAdminSession(res);
    return { authenticated: true };
}
export function adminLogout(res) {
