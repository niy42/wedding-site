...
describe("contribution validation",()=>{
 it("accepts a valid NGN contribution",()=>{expect(parseContributionInput({categoryId:"honeymoon",money:{amountMinor:100000,currency:"NGN"},supporter:{name:"Ada",email:"ada@example.com"}}).supporter.email).toBe("ada@example.com")});
